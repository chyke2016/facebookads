...
<div class="copyrights">
     <p>© 2017 FaceBookAds. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">Chyke</a> </p>
</div>  
              ...
              <ul id="menu" >
                ...
                <li><a href="#"><i class="fa fa-cogs"></i><span>Ads</span><span class="fa fa-angle-right" style="float: right"></span></a>
                  <ul>
                    ...
                    <li><a href="{{ route('home') }}">View Ads</a></li>                    
